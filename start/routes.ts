...
router
  .group(() => {
    ...
    router.get('/share-groups/:id/gems/minimal', [SharingController, 'showGroupGemsMinimal'])
    router.get('/share-groups/:id/gems', [SharingController, 'showGroupGems'])
    router.get('/shared-gems/:id', [SharingController, 'showSharedGem'])
...
router
  .group(() => {
    ...
    router.put('/notifications/read', [NotificationsController, 'update'])
